...
>>>>>>> e3f4f89 (engine: walk-forward folds in parallel processes (wf_pool), bit-identical rows to the in-line loop; EDGELOG_VALIDATE_WORKERS; stack-doc changelog for the 09-07/08 runner + engine work)
