"""
ORB 3.6 — ENTRY VARIANT E3: lowest drawdown + best lockbox PF.
...
6 of 192 survived. This file is one of the three distinct survivors.
    ...
    entry: OR 2 - first-candle dir - close-confirm - buf 0.30 - v-pace 0.9 - ATR 0.7
...
with a REAL windowed run, not a slice):
    full net $309,703  -  maxDD $26,030  -  net/DD 11.90
    lockbox $95,542 at PF 1.712  -  rolling-12mo win 74.3%, worst -$12,939
...
_spec = _ilu.spec_from_file_location("_orb36_base_e3", _SRC)
_base = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_base)

STRATEGY_NAME = 'ORB 3.6 · entry variant E3 — lowest drawdown + best lockbox PF, pinned'
DESCRIPTION   = ("First re-optimisation of the ENTRY under the new ride+BE exit. "
                 ...
                 "(lowest drawdown + best lockbox PF). Judge on WF folds vs run #234's 7/8, not the offline net.")
...
DEFAULT_PARAMS = {
    ...
    "vpace_filter":   {"default": 0.9,  "min": 0.9,  "max": 0.9,  "step": 0.1,  "type": "float", "label": "Volume-pace gate (pre-fill bars only) — PINNED"},
