"""
NOISE 1.9 HSQ243 -- the RETIRED #243 crown keeping only trades taken during an hourly squeeze.
...
This configuration was measured there but has never been the CHAMPION of an Auto-Validate:
  it was one of run #321's 27 grid cells, and #321's search crowned the 30-minute cell instead.
...
WHAT THIS FILE IS
  ...
  586 trades, profit factor 2.233, 2024 onward 2.140, sealed year 1.999.
...
_base = _load("NOISE_1_0.py", "_n10_for_noise_1_9_hsq243")
_sq = _load("NOISE_1_1_SBS_V90_SQ.py", "_sq_for_hsq")   # run #321 compression function, by import

STRATEGY_NAME = "NOISE 1.9 retired crown 243 x hourly squeeze filter (neighbourhood)"
DESCRIPTION = ("The retired NOISE crown (run 243) frozen; a trade is kept only when the squeeze on the verification timeframe was compressed at its decision bar. Centred on the textbook hourly squeeze.")

_AUGUR_MARKET = {"instrument": "NQ", "timeframe": "5m"}
_AUGUR_PARENT = "NOISE_1_0.py"

_FROZEN = {'lookback': 44, 'band_mult_long': 0.75, 'band_mult_short': 1.5, 'exit_mode': 'vwap', 'side': 'Both', 'window': 'all_day', 'flat_eod': True, 'skip_holidays': False, 'stop_mode': 'bandwidth', 'stop_k': 1.75, 'confirm_bars': 1, 'daytype_mode': 'skip_bot_short', 'daytype_lo': 0.2, 'daytype_hi': 0.8, 'vol_skip_pct': 90.0}
