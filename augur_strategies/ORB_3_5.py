...
STRATEGY_NAME = 'ORB 3.5 · all-legal filter space'
...
DEFAULT_PARAMS = {
    "or_bars":       {"default": 1,    "min": 1,   "max": 6,   "step": 1,    "type": "int",   "label": "Opening range (bars)"},
    "trade_mode":    {"default": "Both", "type": "str", "options": ["Both", "First-candle dir", "Long Only", "Short Only"], "label": "Direction"},
    "stop_frac":     {"default": 0.75, "min": 0.5, "max": 2.0, "step": 0.25, "type": "float", "label": "Stop (x range width)"},
    "breakout_buf":  {"default": 0.0,  "min": 0.0, "max": 0.3, "step": 0.05, "type": "float", "label": "Breakout buffer"},
    "close_confirm": {"default": False, "type": "bool", "options": [False, True], "label": "Confirm at bar close"},
    "partial_exit_R":{"default": 0.0,  "min": 0.0, "max": 4.0, "step": 0.5,  "type": "float", "label": "Partial exit (x risk)"},
    "trail_bars":    {"default": 5,    "min": 0,   "max": 12,  "step": 1,    "type": "int",   "label": "Trailing stop (bars)"},
    "target_R":      {"default": 0.0,  "min": 0.0, "max": 6.0, "step": 0.5,  "type": "float", "label": "Target (x risk)"},
    "atr_filter":    {"default": 0.0,  "min": 0.0, "max": 1.1, "step": 0.1,  "type": "float", "label": "Vol-regime filter (trailing)"},
    "vpace_filter":  {"default": 0.0,  "min": 0.0, "max": 1.2, "step": 0.1,  "type": "float", "label": "Volume-pace gate (pre-fill bars only)"},
    "gap_min":       {"default": 0.0,  "min": 0.0, "max": 0.5, "step": 0.05, "type": "float", "label": "Min overnight gap (trailing-ATR units)"},
    "orw_min":       {"default": 0.0,  "min": 0.0, "max": 0.7, "step": 0.1,  "type": "float", "label": "Min OR-width percentile (prior 20 sessions)"},
    "entry_cutoff":  {"default": 0,    "min": 0,   "max": 24,  "step": 2,    "type": "int",   "label": "Entry window (bars after OR, 0 = all day)"},
