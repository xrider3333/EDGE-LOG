...
STRATEGY_NAME = 'ORB 3.4 · legal volume-pace gate'
...
DEFAULT_PARAMS = {
    ...
    "vpace_filter": {
        "default": 0.8, "min": 0.0, "max": 1.4, "step": 0.1, "type": "float",
        "label": "Volume-pace gate (× trailing norm)",
        "tooltip": "Require the session's volume SO FAR (every bar before this one) to be at "
