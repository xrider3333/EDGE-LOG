"""
ORB 3.6 — PLATEAU NEIGHBOUR OF RUN #234: target 4.5R.
...
This file = run #234's config with ONE knob moved: target 4.5R.

Offline reading (NQ 5m RTH no-adj, 0.533 pts/RT, 1 contract, run #230's window):
    full-history net $384,359  ·  lockbox $82,738  ·  net/DD 13.19
...
_spec = _ilu.spec_from_file_location("_orb36_base_t45", _SRC)
_base = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_base)

STRATEGY_NAME = 'ORB 3.6 · #234 neighbour — target 4.5R, pinned'
DESCRIPTION   = ("Run #234's ride+BE config with ONE knob moved: target 4.5R. Pinned to a "
...
DEFAULT_PARAMS = {
    ...
    "target_R":       {"default": 4.5,  "min": 4.5,  "max": 4.5,  "step": 0.5,  "type": "float", "label": "Target (× risk) — PINNED"},
