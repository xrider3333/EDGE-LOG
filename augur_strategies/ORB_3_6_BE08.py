"""
ORB 3.6 — PLATEAU NEIGHBOUR OF RUN #234: breakeven 0.8R.
...
This file = run #234's config with ONE knob moved: breakeven 0.8R.

Offline reading (NQ 5m RTH no-adj, 0.533 pts/RT, 1 contract, run #230's window):
    full-history net $394,864  ·  lockbox $94,268  ·  net/DD 13.44
...
_spec = _ilu.spec_from_file_location("_orb36_base_be08", _SRC)
_base = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_base)

STRATEGY_NAME = 'ORB 3.6 · #234 neighbour — breakeven 0.8R, pinned'
DESCRIPTION   = ("Run #234's ride+BE config with ONE knob moved: breakeven 0.8R. Pinned to a "
