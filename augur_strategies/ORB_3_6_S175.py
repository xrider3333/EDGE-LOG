"""
ORB 3.6 — PLATEAU NEIGHBOUR OF RUN #234: stop 1.75x.
...
This file = run #234's config with ONE knob moved: stop 1.75x.

Offline reading (NQ 5m RTH no-adj, 0.533 pts/RT, 1 contract, run #230's window):
    full-history net $364,461  ·  lockbox $90,036  ·  net/DD 12.26
...
_spec = _ilu.spec_from_file_location("_orb36_base_s175", _SRC)
_base = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_base)

STRATEGY_NAME = 'ORB 3.6 · #234 neighbour — stop 1.75x, pinned'
DESCRIPTION   = ("Run #234's ride+BE config with ONE knob moved: stop 1.75x. Pinned to a "
