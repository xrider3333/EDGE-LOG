"""
ORB 3.6 — PLATEAU NEIGHBOUR OF RUN #234: target 5.0R.
...
This file = run #234's config with ONE knob moved: target 5.0R.

Offline reading (NQ 5m RTH no-adj, 0.533 pts/RT, 1 contract, run #230's window):
    full-history net $389,039  ·  lockbox $86,988  ·  net/DD 13.35
...
_spec = _ilu.spec_from_file_location("_orb36_base_t50", _SRC)
_base = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_base)

STRATEGY_NAME = 'ORB 3.6 · #234 neighbour — target 5.0R, pinned'
DESCRIPTION   = ("Run #234's ride+BE config with ONE knob moved: target 5.0R. Pinned to a "
...
DEFAULT_PARAMS = {
    ...
    "target_R":       {"default": 5.0,  "min": 5.0,  "max": 5.0,  "step": 0.5,  "type": "float", "label": "Target (× risk) — PINNED"},
