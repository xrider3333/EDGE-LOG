...
STRATEGY_NAME = 'ORB BASELINE · #125 knobs, no filter (legal)'
...
DEFAULT_PARAMS = {
    ...
    "stop_frac":      {"default": 0.75, "min": 0.75, "max": 0.75, "step": 0.25, "type": "float", "label": "Stop (x range width) - PINNED"},
    "vpace_filter":   {"default": 0.0,  "min": 0.0,  "max": 0.0,  "step": 0.1, "type": "float", "label": "Volume-pace gate - PINNED OFF (this is the bare baseline)"},
    "vol_filter":     {"default": 0.0,  "min": 0.0,  "max": 0.0,  "step": 0.25, "type": "float", "label": "Legacy look-ahead filter - PINNED OFF"},
    "breakout_buf":   {"default": 0.0,  "min": 0.0,  "max": 0.0,  "step": 0.05, "type": "float", "label": "Breakout buffer - PINNED"},
    "close_confirm":  {"default": False, "type": "bool", "options": [False],                      "label": "Confirm at bar close - PINNED OFF (touch entry is the edge)"},
...
PARAM_GRID_PRESETS = {
    ...
    "Short  (scale-out core — 2 knobs only)": {
        ...
        "vpace_filter": [1.0], "breakout_buf": [0.0], "atr_filter": [0.0],
    ...
    "Long   (full — cap + regime)": {
        ...
        "stop_frac": [0.5, 0.75, 1.0], "vpace_filter": [1.0],
