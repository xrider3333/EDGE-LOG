"""
ORB 4.1 — THE ENTRY WINDOW, on the run #234 crown (2026-08-26 hunt, round 5).
...
NAMED 4.1, NOT 4.0: a concurrent session already owned ORB_4_0.py (the prior-day range
gate) and this file briefly overwrote it on main on 2026-08-26. Theirs is restored at
its own name; this one moved. Nothing here ever ran under the 4.0 name.
...
STRATEGY_NAME = 'ORB 4.1 · legal base + breakeven'
...
# Run:  python augur_strategies/ORB_4_1.py
# ─────────────────────────────────────────────────────────────────────────────
if __name__ == "__main__":
    ...
    assert same, "ORB_4_1 with both knobs off must reproduce ORB_3_6 exactly"
