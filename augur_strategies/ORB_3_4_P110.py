...
STRATEGY_NAME = 'ORB 3.4 · v-pace 1.1x, pinned'
...
DEFAULT_PARAMS = {
    ...
    "vpace_filter":   {"default": 1.10, "min": 1.10, "max": 1.10, "step": 0.1, "type": "float", "label": "Volume-pace gate - PINNED 1.10x"},
...
PARAM_GRID_PRESETS = {
    ...
    "Short  (scale-out core — 2 knobs only)": {
        ...
        "vpace_filter": [1.1], "breakout_buf": [0.0], "atr_filter": [0.0],
    ...
    "Long   (full — cap + regime)": {
        ...
        "stop_frac": [0.5, 0.75, 1.0], "vpace_filter": [1.1],
