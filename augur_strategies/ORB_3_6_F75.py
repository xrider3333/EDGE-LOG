"""
ORB 3.6 — PINNED CANDIDATE F75: the run #234 crown with the vol-regime filter tightened to 0.75.
...
vol-regime filter stood the paper leg down for ten straight sessions from 2026-08-13.
    ...
    offline: net $386,710 - maxDD $28,477 - LB $92,383 - roll12 win 73.2%, worst -$16,349
...
_spec = _ilu.spec_from_file_location("_orb36_f75", _SRC)
_base = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_base)

STRATEGY_NAME = 'ORB 3.6 - candidate F75: the vol-regime filter tightened to 0.75, pinned'
DESCRIPTION   = ("The #234 crown with the vol-regime filter tightened to 0.75. Round-5 filter sweep candidate: "
...
DEFAULT_PARAMS = {
    ...
    "atr_filter":     {"default": 0.75,  "min": 0.75,  "max": 0.75,  "step": 0.05, "type": "float", "label": "Vol-regime filter (trailing) - PINNED (the lever under test)"},
    "vpace_filter":   {"default": 0.70,  "min": 0.70,  "max": 0.70,  "step": 0.05, "type": "float", "label": "Volume-pace gate (pre-fill bars only) - PINNED"},
