"""
ORB 3.9 — PINNED CANDIDATE AB12: crown #234 + arm breakeven after 12 bars (60 minutes).
...
drawdown and half the worst rolling year, for about a third less money.
    ...
    offline: net $269,484 · maxDD $18,394 · net/DD 14.65 · LB $91,272 · roll12 win 77.0%, worst -$9,284
...
_spec = _ilu.spec_from_file_location("_orb39_ab12", _SRC)
_base = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_base)

STRATEGY_NAME = 'ORB 3.9 · candidate AB12 — breakeven armed at 12 bars, pinned'
DESCRIPTION   = ("The #234 crown with breakeven ALSO armed once the trade is 12 bars "
                 "(60 minutes) old. A defensive re-shape: about half the drawdown and "
...
DEFAULT_PARAMS = {
    ...
    "be_after_bars":  {"default": 12,   "min": 12,   "max": 12,   "step": 2,    "type": "int",   "label": "Arm breakeven after N bars — PINNED (the lever under test)"},
