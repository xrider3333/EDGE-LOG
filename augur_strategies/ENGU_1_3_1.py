...
# -- Identity -----------------------------------------------------------------
STRATEGY_NAME = 'ENGU 1.3.1 (CLAUDE)'
DESCRIPTION   = (
...
def run_backtest(
    ...
    for i in range(start_idx, n):
        ...
        raw_bull = bull and closes[i] > hh
        raw_bear = bear and closes[i] < ll
        ...
        bull_sig = raw_bull and opp_pass_bull and atr_pass and vol_pass and trend_bull
        bear_sig = raw_bear and opp_pass_bear and atr_pass and vol_pass and trend_bear
