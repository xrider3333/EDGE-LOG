"""
ORB 3.6 — PINNED CANDIDATE F8080: the run #234 crown with both filters tightened harder, 0.80 / 0.80.
...
vol-regime filter stood the paper leg down for ten straight sessions from 2026-08-13.
    ...
    offline: net $367,833 - maxDD $32,940 - LB $101,017 - roll12 win 76.5%, worst -$18,199
...
_spec = _ilu.spec_from_file_location("_orb36_f8080", _SRC)
_base = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_base)

STRATEGY_NAME = 'ORB 3.6 - candidate F8080: both filters tightened harder, 0.80 / 0.80, pinned'
DESCRIPTION   = ("The #234 crown with both filters tightened harder, 0.80 / 0.80. Round-5 filter sweep candidate: "
...
DEFAULT_PARAMS = {
    ...
    "atr_filter":     {"default": 0.80,  "min": 0.80,  "max": 0.80,  "step": 0.05, "type": "float", "label": "Vol-regime filter (trailing) - PINNED (under test)"},
