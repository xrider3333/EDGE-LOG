"""
TTMSQZ 3.0 R5ES15 — round-5 NEIGHBOURHOOD: the compression dial, on ES 15m range-break.
...
lockbox = last 12 months): 963 trades / $66,264 / PF 1.28 / DD $15,865 / MAR 4.18 / lockbox +$4,169 - about 60 trades a year.
Robustness of that centre: 9 of 13 single-knob neighbours keep profit factor 1.15 or better with a positive lockbox.
...
_FROZEN = {'bb_mult': 2.0, 'min_sq_bars': 1, 'entry_fill': 'range_break', 'exit_mode': 'ride', 'fade_bars': 1, 'stop_atr': 2.0, 'eod_cutoff': 3, 'gate_tf_min': 60, 'gate_mode': 'sq_on', 'gate_bars': 4, 'gate_fired_k': 3, 'direction': 'both'}
...
STRATEGY_NAME = 'TTMSQZ 3.0 R5ES15 · ES 15m range-break, compression dial'
DESCRIPTION = ("Round-5 neighbourhood: a stop entry at the squeeze range edge on 15-minute ES, held to the close with only the protective stop. The verification timeframe must be compressed "
...
PARAM_GRID_PRESETS = {"Short  (ES 15m range-break neighbourhood)": {'gate_len': [14, 16, 20], 'gate_ratio': [1.0, 1.15, 1.3], 'length': [16, 20, 24], 'kc_mult': [1.5, 1.75]}}
