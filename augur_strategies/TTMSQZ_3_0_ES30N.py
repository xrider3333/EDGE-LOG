"""
TTMSQZ 3.0 ES30N — NEIGHBOURHOOD validate target for the round-4 pocket (ES 30m Carter).
...
STRATEGY_NAME = 'TTMSQZ 3.0 ES30N · ES 30m Carter neighbourhood (60m squeeze-on verified)'
DESCRIPTION = ("Round-4 pocket with a tight neighbourhood around it: Carter entry with the momentum-fade exit on 30-minute ES, verified by the hourly squeeze being compressed. Only four "
...
PARAM_GRID_PRESETS = {
    "Short  (ES 30m Carter neighbourhood)": {'kc_mult': [1.25, 1.5, 1.75], 'stop_atr': [1.5, 2.0, 2.5], 'eod_cutoff': [1, 3, 5], 'gate_len': [16, 20, 24]},
}
