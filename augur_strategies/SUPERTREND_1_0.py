"""
ES/NQ SuperTrend Trend Following v1 (Lighter)
...
STRATEGY_NAME = 'SUPERTREND 1.0 · trend-following (lighter)'

DESCRIPTION = (
    "Basic SuperTrend trend following strategy with optional EMA filter. "
    "Good starting point for ES/NQ 1m/5m."
)
...
DEFAULT_PARAMS = {
    "atr_period": {
        "default": 10, "min": 5, "max": 30, "step": 1, "type": "int",
        "label": "ATR Period",
    },
    "multiplier": {
        "default": 3.5, "min": 1.5, "max": 5.0, "step": 0.1, "type": "float",
        "label": "SuperTrend Multiplier",
    },
    "ema_len": {
        "default": 200, "min": 50, "max": 300, "step": 10, "type": "int",
        "label": "EMA Length (Optional Filter)",
    },
    "use_ema_filter": {
        "default": True, "type": "bool",
        "label": "Use EMA Trend Filter",
    },
}
