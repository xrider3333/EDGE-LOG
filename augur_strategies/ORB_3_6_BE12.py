"""
ORB 3.6 — PLATEAU NEIGHBOUR OF RUN #234: breakeven 1.2R.
...
This file = run #234's config with ONE knob moved: breakeven 1.2R.

Offline reading (NQ 5m RTH no-adj, 0.533 pts/RT, 1 contract, run #230's window):
    full-history net $384,289  ·  lockbox $79,088  ·  net/DD 13.36
...
_spec = _ilu.spec_from_file_location("_orb36_base_be12", _SRC)
_base = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_base)

STRATEGY_NAME = 'ORB 3.6 · #234 neighbour — breakeven 1.2R, pinned'
DESCRIPTION   = ("Run #234's ride+BE config with ONE knob moved: breakeven 1.2R. Pinned to a "
...
DEFAULT_PARAMS = {
    ...
    "be_after_R":     {"default": 1.2,  "min": 1.2,  "max": 1.2,  "step": 0.1,  "type": "float", "label": "Breakeven after (× risk) — PINNED at the plateau center"},
