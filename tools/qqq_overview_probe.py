...
overview rebuild (v73.498). Renders augurSub='qqqpaper' against two fixtures --
the real 2-trade doc and a synthetic ~40-trade / 3-leg / 2-open-position doc --
...
def main():
    ...
    print('Screenshots:', real_shot, mock_shot)

    fails = []
    for nm, r in [('real', r1), ('mock', r2)]:
        if r.get('err'):
