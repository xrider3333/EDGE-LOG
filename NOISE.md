...
**Which base should KEEL sit on?** (`tools/r60_noise_keel_base_shootout.py`, one tape to 2026-09-16, run #382's own stretches, KEEL v12 walked on each base's own trades.) Return per dollar of drawdown, walk-forward | lockbox: #304 raw 2.16 | 2.25; #304 + KEEL 2.20 | 3.75; **#382's 30-min 2.0x pick (the live Webull base) 2.67 | 2.33, and with KEEL (the live stack) 2.60 | 2.77**; **hourly squeeze 1.5x alone 2.84 | 2.81 - best on both**, and with KEEL 2.50 | 3.21; hourly 1.25x 2.48 | 2.52, with KEEL 2.27 | 3.59. Every stack beats the crown traded at the same mean size. Two readings: (1) on the tape through September #382's pick now edges the crown on both stretches (round 55 rejected it on the sealed year alone, by a narrow MAR margin and +43% drawdown) - it is not a bad base, it is a louder one; (2) **KEEL on top of a squeeze-sized base LOWERS walk-forward return per drawdown every time** (2.67 to 2.60, 2.84 to 2.50, 2.48 to 2.27) because KEEL carries its own hourly-squeeze 1.5x and the bet is counted twice; KEEL's lockbox gains were read on years its schedule was designed on. The live stack makes the most dollars (walk-forward 84%/yr on $100k, $32k drawdown); hourly 1.5x alone makes the most per dollar of drawdown (85%/yr if sized to the same $30k).
...
adoption 2026-08-10 (0/12 on ORB) and re-tested on NOISE itself 2026-09-02 (0/18, but every
cell raised pre-lockbox profit and the deciding lockbox leg is a coin flip - see the round-6
section); this leg too is forward evidence only.
